export default {
    ...
    ServiceConfigFlow : {
        ...
        Pdf:{
            ...
            intro: "Email Invoice Digitizing enables {customerName} to receive invoices as email attachments. OpusCapita has therefor allocated an email address per buyer unit. The address will have the following format:",
